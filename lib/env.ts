...
const envSchema = z.object({
  ...
  // Optioneel: zonder deze variabele draait de app precies zoals voorheen. Zonder
  // ANTHROPIC_API_KEY wordt het genereren van Nederlandse teksten stil overgeslagen.
  //
